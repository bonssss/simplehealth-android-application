...
public class MedicineCart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datebutton = findViewById(R.id.medicinecartdatebutton1);
        //timecartbutton = findViewById(R.id.medicinecartdatebutton21);
        cartback = findViewById(R.id.medicinebuttonback11);
        cartcheck = findViewById(R.id.medicinecheckbutton11);
        txttotal = findViewById(R.id.medicinecarttextviewcost1);
        lst = findViewById(R.id.medicinecartlistview1);
...
//        txttotal.setText("Total Cost "+totalamount);
        ...
        cartback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MedicineCart.this, BuyMedicineActivity.class));
        ...
        cartcheck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(MedicineCart.this, BuyMedicineBookActivity.class);
